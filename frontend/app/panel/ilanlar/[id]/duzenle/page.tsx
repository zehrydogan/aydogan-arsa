...
import { useProperty, useUpdateProperty } from '@/hooks/usePropertyManagement'
...
export default function EditPropertyPage() {
    ...
    // Form'u property verisiyle doldur
    useEffect(() => {
        if (property) {
            reset({
            ...
            <DashboardLayout>
                <div className="p-6">
                    <div className="text-center">
                        ...
                        <button
                            onClick={() => router.push('/panel/ilanlar')}
            ...
            <div className="p-6">
                ...
                <div className="mb-8">
                    <div className="flex items-center space-x-4 mb-4">
                        <button onClick={() => router.push('/panel/ilanlar')} className="p-2 text-gray-400 hover:text-gray-600 rounded-lg">
                            <ArrowLeft className="w-5 h-5" />
                        </button>
                        <div>
                            <h1 className="text-3xl font-bold text-gray-900">Arsa İlanını Düzenle</h1>
                            ...
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                                        ...
                                        <label className="flex items-center">
                                            <input {...register('details.manzaraDeniz')} type="checkbox" className="rounded border-gray-300 text-green-600 focus:ring-green-500" />
                                            <span className="ml-2 text-sm text-gray-700">Deniz Manzarası</span>
                                        </label>
                                        <label className="flex items-center">
                                        ...
                                        <label className="flex items-center">
                                            <input {...register('details.manzaraGol')} type="checkbox" className="rounded border-gray-300 text-green-600 focus:ring-green-500" />
                                            <span className="ml-2 text-sm text-gray-700">Göl Manzarası</span>
                                        </label>
                                        <label className="flex items-center">
